...
// Import backend URL from environment variables
...
const UploadMaterialPage: React.FC<UploadMaterialProps> = ({ onUploadSuccess }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!level || !courseCode || !courseTitle || !material || !description.trim()) {
        ...
        try {
            ...
            const response = await axios.post(`${API_BASE_URL}/materials`, uploadFormData, {
                headers: {
            ...
            // Call upload success callback if provided
            if (onUploadSuccess) {
                onUploadSuccess();
            }
        } catch (error: any) {
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">
                                        {upload.courseCode} | {upload.fileName} | Status: {upload.status}
                                    </p>
                                </div>
                            </li>
                        ))}
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
                        <div className="flex justify-between items-center p-4">
                            <h2 className="text-xl sen-extrabold text-black/75">Upload Material</h2>
                            <button 
                        ...
                        <form onSubmit={handleSubmit} className="p-4 space-y-4">
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label htmlFor="level" className="block text-sm sen-medium text-gray-700">
                                ...
                                <div>
                                    <label htmlFor="courseCode" className="block text-sm sen-medium text-gray-700">
                            ...
                            <div>
                                <label htmlFor="courseTitle" className="block text-sm sen-medium text-gray-700">
                            ...
                            <div>
                                <label htmlFor="description" className="block text-sm sen-medium text-gray-700">
                                ...
                                <div className="flex items-center justify-center w-full">
                                    <label className="w-full flex flex-col items-center px-4 py-3 bg-white text-green-500 rounded-lg shadow-md tracking-wide border-2 border-dashed border-green-300 cursor-pointer hover:bg-green-100">
                                        ...
                                        <span className="mt-2 text-sm leading-normal">
                                            {formData.material ? formData.material.name : 'Select a file'}
                                        </span>
                                        <input
                                            type="file"
                                            className="hidden"
