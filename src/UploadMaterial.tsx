    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="bg-blue-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" disabled={uploading}>
